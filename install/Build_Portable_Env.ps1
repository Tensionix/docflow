...
Write-Host "======================================================================"
Write-Host "AUDION DOCFLOW - BUILD PORTABLE ENV (PS)"
Write-Host "======================================================================"
...
if ($pthLines -notcontains "..") {
    $importIndex = [Array]::IndexOf($pthLines, "import site")
    if ($importIndex -gt 0) {
        $pthLines = @($pthLines[0..($importIndex - 1)]) + ".." + @($pthLines[$importIndex..($pthLines.Count - 1)])
