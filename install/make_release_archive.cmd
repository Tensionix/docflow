...
title Audion DocFlow - Make Release Archive
...
echo      Cleaning local runtime state from staged release...
call :CLEAN_STAGE_DIR "%STAGE_PROJECT%\._runtime"
call :CLEAN_USER_DIR "%STAGE_PROJECT%\input"
call :CLEAN_USER_DIR "%STAGE_PROJECT%\output"
call :CLEAN_STAGE_DIR "%STAGE_PROJECT%\report"
call :CLEAN_STAGE_DIR "%STAGE_PROJECT%\logs"
call :CLEAN_STAGE_DIR "%STAGE_PROJECT%\install\download"
call :REMOVE_PYCACHE "%STAGE_PROJECT%"
...
:BANNER
echo ======================================================================
echo   AUDION DOCFLOW - MAKE RELEASE ARCHIVE
echo ======================================================================
echo Root:    %ROOT%
...
:CLEAN_STAGE_DIR
set "TARGET=%~1"
if exist "%TARGET%\" rd /s /q "%TARGET%" >nul 2>nul
mkdir "%TARGET%" >nul 2>nul
break > "%TARGET%\.gitkeep"
goto :eof
...
del /s /q "%TARGET%\*.pyc" "%TARGET%\*.pyo" >nul 2>nul
goto :eof
