...
For projects that use Word COM helpers, PowerShell is needed at runtime too.
Use:
...
`system_core\powershell\` is reserved for the portable PowerShell runtime. Do
not place project scripts in that folder.
